...
{\Large\textcolor{darkbg}{Agentic AI Real Estate Advisory Assistant}}\\[0.2cm]
\rule{\textwidth}{1.5pt}\\[1.5cm]

{\large\textbf{Milestone 2 — End-Semester Submission}}\\[0.3cm]
{\normalsize Artificial Intelligence \& Machine Learning}\\[2cm]
